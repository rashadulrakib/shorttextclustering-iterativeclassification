...
maxPercent = 85
percentIncr = 5
#trainFile = "/home/owner/PhD/Proposal/UCT-clean/train"
#testFile = "/home/owner/PhD/Proposal/UCT-clean/test"
#traintestFile = "/home/owner/PhD/Proposal/UCT-clean/traintest"
#textsperlabelDir="/home/owner/PhD/Proposal/UCT-clean/semisupervised/textsperlabel/"
#dataFileTxtTrue = "/home/owner/PhD/Proposal/UCT-clean/1-1-2015-quarter-clustering.small.utc_true_data"
#extClustFile = "/home/owner/PhD/Proposal/UCT-clean/utc_k_means_preds"
...
def EvaluateByPurity(traintestFile):
 ...
 print("Completeness: %0.4f" % metrics.completeness_score(trues, preds))
...
def GenerateTrainTest2List(listtuple_pred_true_text):
 ...
 #for itr in range(maxIterations):
 #for percentTrainData in range (minPercent, maxPercent, percentIncr):
 #trainDataRatio = GenerateTrainTest2_Percentage(percentTrainData);
 #print(str(itr)+","+str(percentTrainData))
 #PerformClassification(trainFile, testFile, traintestFile)
 #EvaluateByPurity(traintestFile)					
