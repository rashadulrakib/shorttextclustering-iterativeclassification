...
def GenerateTrainTest2List(listtuple_pred_true_text, fixedMinP, maxP, minDelta):
 print("Initial---------")
 ...
 for itr in range(maxIterations):
  ...
  if absPercentDiff<minDelta:
   if randPercent >= minDelta:
    randPercent = min(randPercent+minDelta, maxP)
...
GenerateTrainTest2List(listtuple_pred_true_text, fixedMinP, maxP, minDelta)
