...
do  
    ...
    do
	    ...
	    python itr_clustering_multipass_external_arg_classification.py $i $fixedMinP $maxP $minDelta> websnippet-2280-kmeans-we-lr-tfidf-out$i-$fixedMinP-$maxP-$minDelta
