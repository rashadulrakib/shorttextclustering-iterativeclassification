...
filelist=glob.glob("/home/owner/PhD/clustering-iterative-classification-tfidf/parameter_tuning/3.2.maxp_0.55_to_0.95_fixedMinP_0.5_minDelta_0.05/websnippet-2280-kmeans-we-lr-tfidf/*")
print(len(filelist))
