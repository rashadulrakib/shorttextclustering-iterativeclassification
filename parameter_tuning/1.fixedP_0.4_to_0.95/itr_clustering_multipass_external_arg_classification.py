...
#print(extParam)
fixedP = float(str(sys.argv[2]))*100
#print(fixedP)
...
def GenerateTrainTest2List_fixed_P(listtuple_pred_true_text, fixedP):
 print("Initial---------")
...
GenerateTrainTest2List_fixed_P(listtuple_pred_true_text, fixedP)
