...
filelist=glob.glob("/home/owner/PhD/clustering-iterative-classification-tfidf/parameter_tuning/1.fixedP_0.4_to_0.95/1.websnippet-2280-kmeans-we-lr-tfidf/*")
print(len(filelist))
