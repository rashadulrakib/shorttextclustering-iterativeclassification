...
filelist=glob.glob("/home/owner/PhD/clustering-iterative-classification-tfidf/parameter_tuning/3.1.minp_0.4_to_0.85_fixedMaxP_0.9_minDelta_0.05/3.1.websnippet-2280-kmeans-we-lr-tfidf/*")
print(len(filelist))
